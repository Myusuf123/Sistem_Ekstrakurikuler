            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php foreach ($prestasi as $p) { ?>
                        <?= form_open('Admin/C_prestasi/update'); ?>
                            ...
                            <div class="form-group col-lg-4 ">
                                ...
                                <select name="ekskull_id" id="ekskull_id" class="custom-select ">
                                    ...
                                    <?php foreach ($jenis as $j) : ?>
                                        <option <?= $p->ekskull_id == $j['id_ekskul'] ? 'selected' : ''; ?> <?= set_select('id_ekskull', $j['id_ekskul']) ?> value="<?= $j['id_ekskul'] ?>"><?= $j['nama_ekskul'] ?> (<?= $j['tahunajaran'] ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
