                ...
                <div class="card-body">
                    <?php foreach ($jadwal as $jw) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_ekskull" id="id_ekskull" class="custom-select col-lg-6">
                                ...
                                <?php foreach ($jenis as $j) : ?>
                                    <option <?= $jw->id_ekskull == $j['id_ekskul'] ? 'selected' : ''; ?> <?= set_select('id_ekskull', $j['id_ekskul']) ?> value="<?= $j['id_ekskul'] ?>"><?= $j['nama_ekskul'] ?> (<?= $j['tahunajaran'] ?>)</option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="row">
                        ...
                        <div class="float-right">
                            <a href="<?= base_url('Admin/Jadwal') ?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>
