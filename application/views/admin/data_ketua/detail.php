            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php foreach ($ketua as $k) { ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <img width="100px" height="130px" src="<?= base_url() ?>assets/img/<?php echo $k->foto ?>" />
                    ...
                    <div class="float-left">
                        <a href="<?= base_url('Admin/Dataanggota/getketua') ?>" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>
                    </div>
